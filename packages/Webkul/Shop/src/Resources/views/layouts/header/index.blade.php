        ...
        <div class="left-content">
            <ul class="logo-container">
                <li>
                    ...
                    <h3 class="logo-text">{{core()->getCurrentChannel()->name}}</h3>
                </li>
            </ul>
            ...
            <ul class="search-container">
                <li class="search-group">
                    ...
                    <input value="{{ app('request')->input('term') }}" type="search" name="term" class="search-field" placeholder="{{ __('shop::app.header.search-text') }}" required>
                        ...
                        <ul class="dropdown-list account customer">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('customer.orders.index') }}">{{ __('shop::app.layouts.orders') }}</a>
                                    </li>
    ...
    <div class="search-responsive mt-10" id="search-responsive">
        <form role="search" action="{{ route('shop.search.index') }}" method="GET" style="display: inherit;">
            <div class="search-content">
                <button style="background: none; border: none; padding: 0px 0px;">
                    <i class="icon icon-search"></i>
                </button>
                <input style="padding-left: 5px" value="{{ app('request')->input('term') }}" type="search" name="term" class="search" placeholder="Search products">
                {{-- <i class="icon icon-menu-back right"></i> --}}
                <button style="background-color: #242424;margin-left:-5px" class="btn btn-sm">Search</button>
            </div>
        </form>
    </div>
</div>
