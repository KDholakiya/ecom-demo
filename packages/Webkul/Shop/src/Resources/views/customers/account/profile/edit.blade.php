            ...
            <form method="post" action="{{ route('customer.profile.edit') }}" @submit.prevent="onSubmit">
                ...
                <div class="edit-form">
                    ...
                    <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="phone" value="{{ old('phone') ?? $customer->phone }}" v-validate="'required|numeric|length:10'" data-vv-as="&quot;{{ __('shop::app.customer.signup-form.phone') }}&quot;">
