...
return [
    [
        ...
        'key' => 'general.social.instagram',
        'name' => 'Instagram',
        'sort' => 1,
        'fields' => [
            [
                'name'          => 'instagram_toggle',
                'title'         => 'Toggle View',
                'type'          => 'boolean',
                'channel_based' => true,
            ],
            [
                ...
                'type' => 'text',
                'validation' => 'required|max:50|url:require_protocol',
                'channel_based' => true,
            ],
            [
        ...
        'key' => 'general.social.whatsapp',
        'name' => 'Whatsapp',
        'sort' => 1,
        'fields' => [
            [
                'name'          => 'whatsapp_toggle',
                'title'         => 'Toggle View',
                'type'          => 'boolean',
                'channel_based' => true,
            ],
            [
                ...
                'type' => 'text',
                'validation' => 'required|url:require_protocol',
                'channel_based' => true,
            ],
            [
                'name' => 'whatsapp_banner',
                'title' => 'Banner',
                'type' => 'image',
                'channel_based' => true,
                'validation' => 'mimes:jpeg,bmp,png,jpg',
